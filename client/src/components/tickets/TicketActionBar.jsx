        ...
        <form onSubmit={handleResolve} className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="block w-full rounded-lg text-sm border border-slate-300 p-2.5 text-slate-900 bg-white placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
      ...
      >
        <div className="space-y-3">
          <p className="text-xs text-slate-600">
            Are you sure you want to mark ticket <strong>{ticket.ticketNumber}</strong> as closed? Once closed, no further state transitions can be performed.
          </p>
          <div className="pt-3 flex items-center justify-end gap-2 border-t border-slate-100">
