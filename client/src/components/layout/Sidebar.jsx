...
export function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 bottom-0 left-0 z-40 w-64 bg-slate-900 text-slate-300 flex flex-col transition-transform duration-200 ease-in-out lg:translate-x-0 lg:static lg:inset-auto ${
        ...
        <div className="p-3 border-t border-slate-800 bg-slate-950/40 shrink-0">
          <div className="p-2.5 rounded-lg bg-slate-800/60 border border-slate-800">
            ...
            <button
              type="button"
              onClick={logout}
              className="w-full flex items-center justify-center gap-1.5 px-2 py-1.5 text-xs font-medium text-slate-300 bg-slate-700/60 hover:bg-rose-900/40 hover:text-rose-300 rounded border border-slate-700 transition-colors cursor-pointer"
            >
